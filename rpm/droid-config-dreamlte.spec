...
%define device dreamlte
%define vendor samsung

%define vendor_pretty Samsung
%define device_pretty Galaxy S8
...
%include patterns/patterns-sailfish-device-adaptation-dreamlte.inc
%include patterns/patterns-sailfish-device-configuration-dreamlte.inc
